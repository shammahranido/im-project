...
if (isset($_GET['appoint_id'])) {
    ...
    if ($reservation) {
        ...
        $appoint_date = $reservation['appoint_date'];
...
<head>
    ...
    <title>Edit Rabies Appointment</title>
    <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css" rel="stylesheet">
</head>
<body class="bg-gray-100">
    <nav class="bg-green-500 p-4 mb-6">
        <div class="container mx-auto flex justify-between items-center">
            <a href="#"></a>
            <a href="admin-menu.php?service=list-rabies-appointment" class="text-white font-bold">X</a>
        </div>
    </nav>
    <div class="max-w-md bg-blue-200 rounded-md p-8 shadow-md w-2/3 mx-auto my-auto items-center">
        <h1 class="text-2xl font-bold mb-4">Edit Rabies Appointment</h1>
            ...
            <?php endif; ?>
        <form action="admin-frontend-rabies-edit.php?appoint_id=<?php echo htmlspecialchars($appoint_id); ?>" method="POST" class="bg-white p-6 rounded shadow-md">
            ...
            <div class="mb-4">
                <label for="appoint_date" class="block text-gray-700">Appointment Date</label>
                <input type="date" id="appoint_date" name="appoint_date" value="<?php echo htmlspecialchars($appoint_date); ?>" class="mt-1 p-2 w-full border border-gray-300 rounded" disabled>
            </div>
            <div class="mb-4">
